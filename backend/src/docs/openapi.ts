...
} from "@/modules/Products/services/product.zod";
import {
  LoginRequestSchema,
  RegisterRequestSchema,
  NewUserRequestSchema,
  GetUsersQuerySchema,
} from "@/modules/User/services/user.zod";
...
registry.registerPath({
  ...
  request: {
    body: {
      content: { "multipart/form-data": { schema: SaveProductRequestSchema } },
    },
  },
  responses: {
...
registry.registerPath({
  ...
  request: {
    body: {
      content: { "multipart/form-data": { schema: SaveCategoryRequestSchema } },
    },
  },
  responses: {
...
registry.registerPath({
  ...
  request: {
    body: {
      content: {
        "multipart/form-data": { schema: UpdateProductRequestSchema },
      },
    },
  },
  responses: {
...
registry.registerPath({
  ...
  request: {
    body: {
      content: {
        "multipart/form-data": { schema: z.object({ image: z.any() }) },
      },
    },
  },
  responses: {
...
registry.registerPath({
  ...
  responses: {
    200: { description: "Órdenes listadas" },
    401: { description: "No autenticado" },
  },
});
...
registry.registerPath({
  ...
  security: [{ bearerAuth: [] }],
  request: {
    body: { content: { "application/json": { schema: FaqCreateSchema } } },
  },
  responses: {
