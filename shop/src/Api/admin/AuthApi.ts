  ...
  return useMutation({
    ...
    mutationFn: async ({
      ...
      const res = await fetchWithTimeout(
        `${baseUrl}/users/${id}/disable?type=${type}`,
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      if (!res.ok) {
        showNotification({
          title: "Error",
          message: data?.error || "No se pudo inhabilitar",
          color: "red",
        });
...
export const useEnableUser = () => {
  ...
  return useMutation({
    ...
    mutationFn: async ({
      ...
      const res = await fetchWithTimeout(
        `${baseUrl}/users/${id}/enable?type=${type}`,
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      if (!res.ok) {
        showNotification({
          title: "Error",
          message: data?.error || "No se pudo habilitar",
          color: "red",
        });
